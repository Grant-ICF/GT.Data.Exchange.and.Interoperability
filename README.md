...
- Follow this link to view the [HMIS API Specification](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/HUD-Data-Lab/Data.Exchange.and.Interoperability/refs/heads/main/hmis_api_ld_0.5.yaml)
- For additional information about the HMIS API Specification please refer to the [HMIS API Reference Guide](https://github.com/HUD-Data-Lab/Data.Exchange.and.Interoperability/blob/main/doc/HMIS%20API%20Reference%20Guide%20v1.0.md)
...
These layers will set a single-source of truth that usable artifacts (OpenAPI specifications, mapping schemas to external standards, and effect handlers for packaged behaviors) can be generated from.
